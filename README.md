...
Also see [other projects](https://github.com/VHSGunzo/Anylinux-sharun?tab=readme-ov-file#projects-that-use-sharun) that use sharun for more. **Didn't find what you were looking for?** Open an issue [here](https://github.com/pkgforge-dev/Anylinux-AppImages/issues) and we will see what we can do.
