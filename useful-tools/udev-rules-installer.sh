...
_check_udev() {
	...
	if [ -d "$CURRENTDIR"/etc/udev/rules.d ]; then
		UDEVDIR="$CURRENTDIR"/etc/udev/rules.d
		set -- "$CURRENTDIR"/etc/udev/rules.d/*
	elif [ -d "$CURRENTDIR"/lib/rules.d ]; then
		UDEVDIR="$CURRENTDIR"/lib/rules.d
		set -- "$CURRENTDIR"/lib/udev/rules.d/*
	elif [ -d "$CURRENTDIR"/usr/lib/rules.d ]; then
		UDEVDIR="$CURRENTDIR"/usr/lib/rules.d
		set -- "$CURRENTDIR"/usr/lib/udev/rules.d/*
	else
