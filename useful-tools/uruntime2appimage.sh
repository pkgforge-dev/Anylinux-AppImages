...
URUNTIME_LINK=${URUNTIME_LINK:-https://github.com/VHSgunzo/uruntime/releases/download/v0.4.6/uruntime-appimage-dwarfs-lite-$ARCH}
DWARFS_LINK=${DWARFS_LINK:-https://github.com/mhx/dwarfs/releases/download/v0.14.0/dwarfs-universal-0.14.0-Linux-$ARCH}
TMPDIR=${TMPDIR:-/tmp}
