...
| `fix-namespaces.hook` | Fixes unprivileged user namespace restrictions (Ubuntu/Debian 24.04+) |
...
| `host-libjack.hook` | Uses the host JACK library instead of the bundled one for better performance |
